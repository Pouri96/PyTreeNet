...
def idiots_splitting(tensor: np.ndarray,
    ...
    Args:
        ...
        strict_checks (bool, optional): If True, raises exceptions when the
            given tensors are incompatible with the given legs. If False, the
            shape compatibility checks are skipped, allowing deliberate
            shape-changing replacements. Defaults to True.
